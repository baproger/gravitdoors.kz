...
class AdminPanelSmokeTest extends TestCase
{
    ...
    public static function panelPages(): array
    {
        return [
            ...
            'финансы — обзор' => ['/admin/finance'],
            'расходы' => ['/admin/expenses'],
            'касса и банк' => ['/admin/cash'],
            'поступления' => ['/admin/incomes'],
            'счета' => ['/admin/invoices'],
            'задолженности' => ['/admin/debts'],
            'бонусы' => ['/admin/bonuses'],
            'зарплата — ведомость' => ['/admin/salary'],
            'моя зарплата' => ['/admin/my-salary'],
